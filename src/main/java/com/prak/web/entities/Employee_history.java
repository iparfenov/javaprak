...
public class Employee_history {
    ...
    private List<Timestamp> promoted_at;
    ...
    public List<Timestamp> getPromoted_at() { return promoted_at; }

    public void setPromoted_at(List<Timestamp> promoted_at) { this.promoted_at = promoted_at; }

...
CREATE SEQUENCE IF NOT EXISTS website.employees_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
    CACHE 1;
ALTER SEQUENCE website.employees_seq
    OWNER TO postgres;

CREATE TABLE IF NOT EXISTS website.employees
(
    employee_id integer NOT NULL DEFAULT nextval('website.employees_seq'::regclass),
...
ALTER TABLE IF EXISTS website.employees
    OWNER to postgres;
ALTER SEQUENCE website.employees_seq
    OWNED BY website.employees.employee_id;


CREATE SEQUENCE IF NOT EXISTS website.bonuses_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
    CACHE 1;
ALTER SEQUENCE website.bonuses_seq
    OWNER TO postgres;

CREATE TABLE IF NOT EXISTS website.bonuses
(
    bonus_id integer NOT NULL DEFAULT nextval('website.bonuses_seq'::regclass),
    name text COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS website.bonuses
    OWNER to postgres;
ALTER SEQUENCE website.bonuses_seq
    OWNED BY website.bonuses.bonus_id;

CREATE SEQUENCE IF NOT EXISTS website.employees_payouts_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
    CACHE 1;
ALTER SEQUENCE website.employees_payouts_seq
    OWNER TO postgres;

CREATE TABLE IF NOT EXISTS website.employees_payouts
(
    payout_id integer NOT NULL DEFAULT nextval('website.employees_payouts_seq'::regclass),
...
ALTER TABLE IF EXISTS website.employees_payouts
    OWNER to postgres;
ALTER SEQUENCE website.employees_payouts_seq
    OWNED BY website.employees_payouts.payout_id;


CREATE SEQUENCE IF NOT EXISTS website.projects_seq
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 2147483647
    CACHE 1;
ALTER SEQUENCE website.projects_seq
    OWNER TO postgres;

CREATE TABLE IF NOT EXISTS website.projects
(
    project_id integer NOT NULL DEFAULT nextval('website.projects_seq'::regclass),
...
ALTER TABLE IF EXISTS website.projects
    OWNER to postgres;
ALTER SEQUENCE website.projects_seq
    OWNED BY website.projects.project_id;
